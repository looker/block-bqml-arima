...
### 2. **BigQuery Dataset for storing ARIMA model details and related tables**
...
> <b> 2. Add New Model </b>
> <b> 3. Add New Explore which Extends the Block's ARIMA Explore </b>
...
#### <font size=5>input_data.view </font><b><font color='red'> REQUIRED
...
| In left pane, change `Connection` to match the connection you specified in your use case model file | thelook_bq |
...
#### <font size=5>model_name_suggestions.explore </font><b><font color='red'> REQUIRED
...
#### <font size=5>arima_training_data.view </font><b><font color='red'> OPTIONAL
